...
public class AccessDB
{
    ...
    public bool Registro( string user, string password, string email )
    {
        StringSQL = "INSERT INTO Users([user_name], [user_password], [user_email])"
        ...
        try
        {
            ...
            Command.Parameters.Add( user, OleDbType.WChar ).Value = user;
            Command.Parameters.Add( password, OleDbType.WChar ).Value = password;
            Command.Parameters.Add( email, OleDbType.WChar ).Value = email;
            Command.CommandText = StringSQL;
            Command.Connection = Conexion;
